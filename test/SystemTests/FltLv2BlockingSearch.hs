...
fltLv2BlockingCasesRowStride =
  ...
  [ltc "row major matrix add" avxVarDeclsSingle toAVXSingle lv2Opts [matrixAdd m1 m2 m3],
   ltc "row major matrix add with residual" avxVarDeclsSingle toAVXSingle lv2Opts [matrixAdd n1 n2 n3],
   ltc "row major matrix add twice" avxVarDeclsSingle toAVXSingle lv2Opts [matrixAdd t1 m1 m2, matrixAdd m3 t1 t1],
   ltc "row major matrix add twice with residual" avxVarDeclsSingle toAVXSingle lv2Opts [matrixAdd lt1 l1 l2, matrixAdd l3 lt1 l2],
...
fltLv2BlockingCasesColStride =
  ...
  [ltc "row major matrix add" avxVarDeclsSingle toAVXSingle lv2Opts [matrixAdd m1_cs m2_cs m3_cs],
   ...
   ltc "row major matrix add twice with residual" avxVarDeclsSingle toAVXSingle lv2Opts [matrixAdd lt1_cs l1_cs l2_cs, matrixAdd l3_cs lt1_cs l2_cs],
